const translations = {
  ...
  "mainTitle": {
    "ko": "NUMÉRO 45: 당신의 행운을 위한 로또 번호 생성기",
    "en": "NUMÉRO 45: Your Lucky Lotto Number Generator",
    "zh": "NUMÉRO 45：您的幸运彩票号码生成器"
  },
  "mainDesc": {
    "ko": "NUMÉRO 45에 오신 것을 환영합니다. 이곳은 당신의 로또 티켓을 위한 개인 맞춤 번호 생성 동반자입니다. 이 도구는 무작위로 생성된 번호를 깔끔하고 아름다운 인터페이스로 제공하도록 설계되었습니다. 복권의 세계에 대한 재미있는 통찰력을 얻으려면 저희 기사를 둘러보시고, 책임감 있게 즐기는 것을 잊지 마세요!",
    "en": "Welcome to NUMÉRO 45, your personal companion for lottery number generation. This tool is designed to provide you with randomly generated numbers for your lottery tickets, all presented in a clean and beautiful interface. Explore our articles for fun insights into the world of lotteries, and remember to play responsibly!",
    "zh": "欢迎来到NUMÉRO 45，您的个人彩票号码生成伴侣。该工具旨在为您提供随机生成的彩票号码，并以简洁美观的界面呈现。浏览我们的文章，获取有关彩票世界的有趣见解，并请记住要负责任地玩彩！"
  },
  "drawButton": {
    "ko": "🎲 번호 생성",
    "en": "🎲 Generate Numbers",
  ...
  "articlesDesc": {
    "ko": "이곳에서는 복권, 전략 및 기타 재미있는 콘텐츠에 대한 기사를 찾을 수 있습니다. 더 많은 소식을 기대해주세요!",
    "en": "Here you will find articles about lotteries, strategies, and other fun content. Stay tuned for more!",
    "zh": "在这里，您将找到有关彩票、策略和其他有趣内容的文章。敬请期待更多内容！"
  },
  "article1Title": {
    "ko": "로또의 역사",
  ...
  "article1Desc": {
    "ko": "고대부터 현대까지, 복권의 매혹적인 역사를 발견해보세요.",
    "en": "Discover the fascinating history of lotteries, from ancient times to the modern day.",
    "zh": "探索从古代到现代的彩票迷人历史。"
  },
  "article2Title": {
    "ko": "번호 선택 전략",
  ...
  "article2Desc": {
    "ko": "로또 번호 선택을 위한 다양한 전략을 살펴보세요. 오락 목적으로만 이용해주세요!",
    "en": "Explore different strategies for picking your lottery numbers. For entertainment purposes only!",
    "zh": "探索选择彩票号码的不同策略。仅供娱乐！"
  },
  "article3Title": {
    "ko": "로또 확률 이해하기",
  ...
  "article3Desc": {
    "ko": "복권 뒤에 숨겨진 확률을 이해하기 위한 간단한 안내서입니다.",
    "en": "A simple guide to understanding the probabilities behind the lottery.",
